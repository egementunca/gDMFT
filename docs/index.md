...
1. [Concepts](concepts.md): model vocabulary and result semantics.
2. [Workflow](workflow.md): how a calculation becomes a selected dataset.
3. [Architecture](architecture.md): package boundaries and dependency rules.
